...
/* Города и регионы взял отсюда: https://ru.wikipedia.org/wiki/%D0%A1%D0%BF%D0%B8%D1%81%D0%BE%D0%BA_%D0%B3%D0%BE%D1%80%D0%BE%D0%B4%D0%BE%D0%B2_%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D0%B8
Обработал в Excel формулами и вставил в код в удобном виде */
$towns = [
    'Адыгея' => ['Адыгейск',
        'Майкоп'],
...
//комбинированный вывод внешнего и вложенного массивов
//foreach ($towns as $key => $value) {
//    if (!is_array($value)) {
...
//    }
//    echo "{$key}:<br>";
//    foreach ($value as $keySubArray => $subArrayValue) {
//        $str .= "{$subArrayValue}, ";
//    }
//    echo trim($str, ', ') . '.<br>';
//    $str = '';
