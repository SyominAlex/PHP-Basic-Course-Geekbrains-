...
$info = queryOne("SELECT id, name, image, short_description, description, price, category_id FROM product WHERE id = {$id}");

echo '<div><img src="./img/' . $info['image'] . '" alt="' . $info['name'] . '"><br><br>';
